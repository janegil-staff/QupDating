...
<div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white p-6">
  <div className="max-w-4xl mx-auto bg-neutral-900 rounded-xl shadow-xl p-6 space-y-6 relative">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <Detail label="Has Children" value={profile.hasChildren ? "Yes" : "No"} />
      <Detail label="Wants Children" value={profile.wantsChildren ? "Yes" : "No"} />
      <Detail label="Smoking" value={profile.smoking} />
      <Detail label="Drinking" value={profile.drinking} />
      <Detail label="Willing to Relocate" value={profile.willingToRelocate ? "Yes" : "No"} />
    </div>

    {/* Looking For */}
    <div>
      <h2 className="text-xl font-semibold text-pink-500">What I'm Looking For</h2>
