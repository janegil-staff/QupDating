    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            At ChooseQup, we believe you should have full control over your
            personal data. Below you'll find all the ways you can manage,
          ...
          >
            <h4
              style={{ color: "#d4d0c8", margin: "0 0 12px", fontWeight: 600 }}
            >
            ...
            <p style={{ marginTop: 16, fontSize: 14, color: "#8a8a9a" }}>
              Your data will be permanently deleted within 30 days. During this
              period, your account will be deactivated and not visible to other
              users.
            </p>
          </Card>
          ...
          >
            ...
            />
            <p style={{ marginTop: 16, fontSize: 14, color: "#8a8a9a" }}>
              Note: Disabling location may affect your ability to see nearby
              matches.
            </p>
          </Card>
          ...
          >
            ...
            >
              <a
                href="mailto:janstovr@gmail.com"
                style={{
                  color: "#d4af7d",
                  textDecoration: "none",
                  fontWeight: 600,
          ...
          >
            <p>
              If you signed in with Google, Apple, or LinkedIn, you can revoke
              ChooseQup's access through those platforms:
            </p>
            <div
              style={{
                marginTop: 12,
            ...
            >
              ...
              <LinkItem
                label="Apple"
                url="https://appleid.apple.com (Sign-In & Security → Sign in with Apple)"
              />
              <LinkItem
                label="LinkedIn"
          ...
          >
            ...
            <p style={{ color: "#b0afa8", fontSize: 15, margin: "0 0 20px" }}>
              If you have any questions about your privacy or need assistance
              managing your data, we're here to help.
            </p>
            <a
              href="mailto:janstovr@gmail.com"
              style={{
          ...
          >
            <a
              href="/privacy"
              style={{ color: "#5a5a6a", fontSize: 13, textDecoration: "none" }}
            >
              Privacy Policy
            </a>
            <a
