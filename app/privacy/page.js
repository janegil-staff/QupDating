        ...
        >
          ...
          <Section number="01" title="Information We Collect">
            <Subsection title="Information You Provide">
              <p>
                When you create an account and use ChooseQup, you may provide us
            ...
            <Subsection title="Information from Third-Party Sign-In">
              <p>
                If you choose to sign in using Google, Apple, or LinkedIn, we
                receive basic profile information from those services, such as
                your name, email address, and profile picture. We only access
                information that you have authorized these services to share
                with us.
              </p>
            </Subsection>
          ...
          <Section number="03" title="How We Share Your Information">
            <Subsection title="With Other Users">
              <p>
                Your profile information (including name, photos, bio, and
                professional details) is visible to other ChooseQup users as
                part of the matchmaking service. Messages you send are visible
                to their recipients.
              </p>
            </Subsection>
            ...
            <Subsection title="With Service Providers">
              <p>
                ...
                cloud hosting, analytics, customer support, and payment
            ...
            <Subsection title="For Legal Reasons">
              <p>
                ...
                safety of ChooseQup, our users, or the public.
              </p>
            </Subsection>
            ...
            <Subsection title="We Do Not Sell Your Data">
              <p>
                ...
                third parties for their marketing purposes. We do not share your
                data with data brokers or advertising networks.
              </p>
            </Subsection>
          </Section>
          ...
          <Section number="04" title="Data Retention">
            <p>
              ...
              active or as needed to provide you with our Service. If you delete
              your account, we will delete or anonymize your personal data
              within 30 days, except where we are required to retain it for
              legal or regulatory purposes. Some information, such as messages
              sent to other users, may persist in the recipients' accounts.
            </p>
          </Section>
          ...
          <Section number="05" title="Data Security">
            <p>
              ...
              protect it, including encryption of data in transit and at rest,
              secure server infrastructure, regular security assessments, and
          ...
          <Section number="07" title="International Data Transfers">
            <p>
              ...
              internationally, we take steps to ensure that appropriate
          ...
          <Section number="08" title="Children's Privacy">
            <p>
              ChooseQup is not intended for anyone under the age of 18. We do
              ...
              quickly as possible. If you believe a child under 18 has provided
          ...
          <Section number="10" title="Changes to This Policy">
            <p>
              ...
              updated policy within the app and updating the "Last updated" date
              above. Your continued use of ChooseQup after any changes
          ...
          <Section number="11" title="Contact Us">
            ...
            >
              <p
                style={{ margin: "0 0 6px", color: "#d4af7d", fontWeight: 600 }}
              >
                ChooseQup Dating
              </p>
              <p style={{ margin: "0 0 4px", color: "#b0afa8" }}>
                Email: janstovr@gmail.com
              </p>
              <p style={{ margin: 0, color: "#b0afa8" }}>
                Website: https://qup.date
              </p>
            </div>
          </Section>
...
function Section({ number, title, children }) {
  return (
    <div style={{ marginBottom: 48 }}>
      ...
      <div style={{ color: "#b0afa8", fontSize: 15 }}>{children}</div>
    </div>
  );
}
